            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{url('/icon')}}" aria-expanded="false"><i class="mdi mdi-face"></i><span
                                       ...
                                       <tbody>
                                        @foreach($list_produk as $produk)
                                           <tr>
                                               ...
                                               <td>
                                                <div class="btn-group">                                                  <a href="{{url('produk', $produk->id)}}" class="btn btn-dark"><i class="fa fa-info"></i></a>
