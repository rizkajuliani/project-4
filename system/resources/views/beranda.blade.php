                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{url('public')}}/assets/images/users/1.jpg" alt="user" class="rounded-circle"
                                    width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button"
                                        ...
                                        <h5 class="m-b-0 user-name font-medium">Rizka Juliani<i
                                                class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email">rzkajliani1100@gmail.com</span>
                                    </a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{url('/produk')}}" aria-expanded="false"><i
                                    class="mdi mdi-border-all"></i><span class="hide-menu">produk</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{url('/table')}}" aria-expanded="false"><i class="mdi mdi-border-all"></i><span
                                    class="hide-menu">kategori</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{url('/promo')}}" aria-expanded="false"><i class="mdi mdi-face"></i><span
                                    class="hide-menu">promo</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{url('/promo')}}" aria-expanded="false"><i class="mdi mdi-file"></i><span
                                    class="hide-menu">Master Data</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="{{url('public')}}/assets/images/users/1.jpg" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{url('public')}}/assets/images/users/4.jpg" alt="user" width="50"
                                            class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{url('public')}}/assets/images/users/5.jpg" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
